    ...
    return (
        <div className="fixed inset-0 flex flex-col items-center justify-center bg-black text-white px-6 overflow-hidden">
                ...
                {authMode === 'selection' && (
                    <div className="flex flex-col gap-3 w-full animate-in fade-in slide-in-from-bottom-4 duration-500">
                        ...
                        <button
                            ...
                            className="w-full h-14 bg-white text-black rounded-2xl flex items-center justify-center gap-3 font-black text-xs uppercase tracking-wider hover:scale-[1.02] active:scale-[0.98] transition-all disabled:opacity-50"
                        >
                            {localLoading ? (
            ...
            <div className="absolute bottom-8 flex items-center gap-4">
                ...
                <div className="text-[9px] font-black text-white/10 tracking-[0.4em] uppercase">Lisnet Web v1.1.9</div>
                <div className="h-px w-6 bg-white/5"></div>
            </div>
        </div>
    );
